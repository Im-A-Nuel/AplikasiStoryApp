package com.coding.aplikasistoryapp.data.remote.paging
...
import com.coding.aplikasistoryapp.data.local.RemoteKeys
...
class StoryRemoteMediator(private val database: StoryDatabase, private val storyRepository: StoryRepository): RemoteMediator<Int, ListStoryItem>() {
    ...
    override suspend fun load(
        ...
        try {
            val responseData = storyRepository.getStorie(page, state.config.pageSize)
